...
INSERT INTO `auth-category_users` VALUES (1,1),(2,1),(3,1),(2,2),(3,3),(3,4),(3,24),(3,26);
...
CREATE TABLE `comment` (
  ...
  CONSTRAINT `comment_blog_id_fk` FOREIGN KEY (`blog_id`) REFERENCES `blog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2020-09-03 10:06:02
